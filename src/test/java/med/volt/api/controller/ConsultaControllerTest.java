...
class ConsultaControllerTest {
    ...
    @Test
    @DisplayName("retornar estado http 400 cuando los datos ingresados sean invalidos")
    @WithMockUser
    ...
    @Test
    @DisplayName("retornar estado http 200 cuando los datos ingresados son validos")
    @WithMockUser
